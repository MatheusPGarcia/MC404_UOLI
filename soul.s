...
rotina_do_alarme:
  ...
  ldr r7, =alarmsAdress     @ Load no endereço de alarmsAdress[0]
...
@  svc 0x0
  ...
  stmfd sp!, {r4-r7}        @ Empilha os registradores que serão sujos no tratamento

Reordenacao_dos_alarmes:

  cmp r4, #0               @ Compara o numero de alarmes que ainda restam com zero
  ...
  ldr r8, [r7, #32]         @ Carrega em r8 o endereço r7 + 32
  str r8, [r7]              @ Salva esse valor no endereço de r7
  add r7, r7, #32           @ Adiciona 32 a r7

  sub r4, r4, #1            @ Subtrai 1 do numero de alarmes que ainda restam para interagir
  b Reordenacao_dos_alarmes

fim_tratamento:
  ldmfd sp!, {r4-r7}        @ Desempilha os registradores que foram sujos durante a ordenação

  sub r5, r5, #4            @ Subtrai 4 de r5
  sub r7, r7, #32           @ Subtrai 32 de r7
...
delay:
  ...
  mov r0, #200              @ Carrega o valor 200 em r0
